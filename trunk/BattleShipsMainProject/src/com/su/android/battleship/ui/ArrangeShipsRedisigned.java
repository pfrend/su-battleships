 ...
 * 
 */
public class ArrangeShipsRedisigned extends Activity {
	...
	protected void rotate(View v) {
		if (selectedShipIndex != -1) {
			...
			if (isShipOk(tmpSFH) && isRotatable) {
				...
				Toast.makeText(ArrangeShipsRedisigned.this,
	...
	private void displayGameScreen() {
		setContentView(R.layout.single_player_arrange_ships);
